...
class Experiment(pydantic.BaseModel):
    ...
    tensor_parameters_raw: TensorParameters = pydantic.Field(default=TensorParameters(), validation_alias="tensor_parameters", serialization_alias="tensor_parameters")
    path_to_weights_raw: str | None = pydantic.Field(default=None, validation_alias="path_to_weights", serialization_alias="path_to_weights")
    path_to_metrics_raw: str | None = pydantic.Field(default=None, validation_alias="path_to_metrics", serialization_alias="path_to_metrics")

    @property
    def path_to_weights(self) -> str | None:
        if self.path_to_experiment_file is not None and self.path_to_weights_raw is not None:
            return os.path.join(
                self.path_to_experiment_file,
                self.path_to_weights_raw
            )
        else:
    ...
    def load_from_path_to_experiment_file(cls, path_to_experiment_file: str):
        ...
        try:
            ...
            experiment.path_to_experiment_file = os.path.dirname(path_to_experiment_file)
