...
class FastNonLinearQuantileRegression(PushForwardOperator, torch.nn.Module):
    ...
    def __init__(
        self, vector_quantile_regression_solver_arguments: dict = {}, *args, **kwargs
    ):
        super().__init__()
    ...
    @classmethod
    def load_class(
        cls, path: str, *args, **kwargs
    ) -> "FastNonLinearQuantileRegression":
        fast_non_linear_quantile_regression = cls()
        fast_non_linear_quantile_regression.load(path, *args, **kwargs)
